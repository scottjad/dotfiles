...
(custom-set-variables
 ...
 '(ac-sources (quote (ac-source-yasnippet ac-source-imenu ac-source-abbrev ac-source-dictionary ac-source-words-in-same-mode-buffers ac-source-files-in-current-dir ac-source-filename)) t)
